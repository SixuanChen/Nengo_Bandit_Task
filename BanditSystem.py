...
socket_means = [q for q in socket_order]
...
class PowerSocket:
    ...
    def __init__(self, v):                
        ...
        self.q = 0   # the true reward value              
    ...
    def charge(self):
        ...
        # value 'q'
        value = np.random.normal( self.q, np.sqrt(self.v) )
...
class SocketTester():
    ...
    def __init__(self, socket=PowerSocket, socket_order=socket_order, multiplier=2, **kwargs ):  
        ...
        self.sockets = [socket(v, **kwargs) for v in socket_order]     
